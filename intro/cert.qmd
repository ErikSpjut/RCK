...
::: {.callout-note}
    Much of the rocket information below has not been updated recently. Approach with caution.
::: 

To participate in High-Power Rocketry you need to be certified with either [NAR][NCRT] or [TRA][TCRT]. There are three levels of certification:

* Level 1 – You can fly with H and I motors.
* Level 2 – You can fly with J, K and L motors.
* Level 3 – You can fly with M and above motors.
...
The high-power rocketry club that we most-often launch with is
the [Rocketry Organization of California (ROC)][ROC]. Barring adverse weather conditions, they
fly every month on the second Saturday at the [Lucerne Valley dry lake bed][ROCL]. They have a couple
of TRA prefects and a large number of NAR observers.
...
just before your flight. You can have someone already Level 1 or above
buy it for you and give it to you when you're ready to prep for launch. Some on-line vendors are willing to sell
you one motor for certification purposes, or you can buy it
at the launch site when you're ready to prep for launch if there is an on-site vendor.
...
for the reloads are even more expensive. Many rocketeers have cases you can borrow for the most common Aerotech sizes,
...
### LOC Weasel
The LOC Weasel has recently gone out of production (OOP) but they may bring it back, and some on-line vendors may still have a stock of them.
It will easily let you
certify Level 1 (assuming you include a GPS Tracker) if you follow the linked construction techniques.
...
is the Aerotech H128W. Recommended assembly instructions are [here](https://pages.hmc.edu/spjut/AdvRoc/CardboardWeaselRocketAssembly.md.html).

### Madcow 1.6" Mini DX3
This rocket is very similar to the LOC Weasel. It will easily let you
certify Level 1 (assuming you include a GPS Tracker) if you follow the linked construction techniques.
In addition to the [kit](https://www.madcowrocketry.com/1-6-mini-dx3/), you will need
an Estes 29mm motor retainer and 5-minute epoxy. The perfect cert motor for this rocket
is the Aerotech H128W. Recommended assembly instructions are found [here](https://pages.hmc.edu/spjut/AdvRoc/CardboardDX3RocketAssembly.md.html).
...
and JB weld. We used modified Arreauxs in our classes for years. It's much sturdier than the Estes
...
and are careful during construction it will last for years. You will want a motor retainer. You can certify
Level 2 on it as well, but you'll want to make certain of your construction techniques. Available from
